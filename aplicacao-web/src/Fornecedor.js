...
export class CadastraFornecedor extends Component{

    render(){
        return (
            <form>
            <div class="form-group">
                <label for="inputAddress">Nome do fonecedor</label>
                <input type="text" class="form-control" id="inputAddress" placeholder="Nome do fonecedor"></input>
            </div>
            <div class="form-row">
            ...
            <div class="form-row">
              ...
              <div class="form-group col-md-4">
                  <label for="inputState">Tipo de produto</label>
                  <select id="inputState" class="form-control">
                    <option selected>Choose...</option>
                    <option>...</option>
                  </select>
